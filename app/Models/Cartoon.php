...
class Cartoon extends Model
{
    ...
    {
        static::deleting(function (Cartoon $cartoon): void {
            $cartoon->files()->delete();
        });
    }
    ...
    /**
     * @return HasMany<CartoonFile, $this>
     */
    public function files(): HasMany
    {
        return $this->hasMany(CartoonFile::class)->orderBy('sort_order')->orderBy('id');
    }
    ...
    {
        return $this->belongsToMany(Genre::class, 'genre_cartoon')->orderBy('genres.name');
    }
    ...
    {
        return $this->belongsToMany(Country::class, 'country_cartoon')->orderBy('countries.name');
    }
    ...
    public function storePoster(UploadedFile $file): void
    {
        ...
        $filename = 'cartoon-'.$this->id.'.'.strtolower($file->getClientOriginalExtension());
