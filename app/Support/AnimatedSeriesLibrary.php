...
class AnimatedSeriesLibrary
{
    ...
    {
        return (string) config('media.animated_series.directory');
    }
    ...
    {
        $used = AnimatedEpisode::query()->pluck('filename');
    ...
    public function isAvailable(string $filename): bool
    {
        ...
        return ! AnimatedEpisode::query()->where('filename', $filename)->exists();
    }
    ...
    {
        $extensions = collect(config('media.animated_series.extensions'))
