...
class BookLibrary
{
    ...
    {
        return (string) config('media.books.directory');
    }
    ...
    {
        $used = BookFile::query()->pluck('filename');
    ...
    public function isAvailable(string $filename): bool
    {
        ...
        return ! BookFile::query()->where('filename', $filename)->exists();
    }
    ...
    {
        $extensions = collect(config('media.books.extensions'))
