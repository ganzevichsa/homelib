...
class CartoonLibrary
{
    ...
    {
        return (string) config('media.cartoons.directory');
    }
    ...
    {
        $used = CartoonFile::query()->pluck('filename');
    ...
    public function isAvailable(string $filename): bool
    {
        ...
        return ! CartoonFile::query()->where('filename', $filename)->exists();
    }
    ...
    {
        $extensions = collect(config('media.cartoons.extensions'))
