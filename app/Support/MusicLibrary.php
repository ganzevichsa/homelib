...
class MusicLibrary
{
    ...
    {
        return (string) config('media.music.directory');
    }
    ...
    {
        $used = AlbumTrack::query()->pluck('filename');
    ...
    public function isAvailable(string $filename): bool
    {
        ...
        return ! AlbumTrack::query()->where('filename', $filename)->exists();
    }
    ...
    {
        $extensions = collect(config('media.music.extensions'))
