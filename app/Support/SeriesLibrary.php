...
class SeriesLibrary
{
    ...
    {
        return (string) config('media.series.directory');
    }
    ...
    public function files(): array
    {
        ...
        $extensions = config('media.series.extensions');
    ...
    {
        $used = Episode::query()->pluck('filename');
    ...
    public function isAvailable(string $filename): bool
    {
        ...
        return ! Episode::query()->where('filename', $filename)->exists();
    }
    ...
    {
        $extensions = collect(config('media.series.extensions'))
