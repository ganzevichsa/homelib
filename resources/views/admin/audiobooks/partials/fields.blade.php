...
<div>
    ...
    <x-text-input id="author" name="author" type="text" class="mt-1 block w-full" :value="old('author', $author ?? '')" required />
    <x-input-error class="mt-2" :messages="$errors->get('author')" />
</div>

<div>
    <x-input-label for="narrator" value="Чтец" />
    <x-text-input id="narrator" name="narrator" type="text" class="mt-1 block w-full" :value="old('narrator', $narrator ?? '')" />
    <x-input-error class="mt-2" :messages="$errors->get('narrator')" />
</div>
...
<div>
    ...
    @if (isset($audiobook) && $audiobook->hasPoster())
