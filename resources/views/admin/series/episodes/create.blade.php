<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Серия для «{{ $series->title }}» · {{ $season->label() }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.series.episodes.store', [$series, $season]) }}" class="mt-6 space-y-4">
                        @csrf
                        ...
                        <div
                            x-data="{
                                url: {{ \Illuminate\Support\Js::from(route('admin.series.episodes.search')) }},
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('admin.series.edit', $series) }}" class="text-sm text-gray-500 underline">Назад</a>
                        </div>
                    </form>
                </div>
            </div>
